...
class _BookTicketsState extends State<BookTickets> {
  ...
  List<DropdownMenuItem<String>> nationalityItems = [
    DropdownMenuItem(child: Text("Indian"), value: "Indian"),
    DropdownMenuItem(child: Text("Foreigner"), value: "Foreigner"),
  ];
  ...
  Future<void> openCheckout() async {
    var options = {
      ...
      "name": "Sample App",
      "description": "Payment for the ticket",
      "external": {
        "wallets": ["paytm"]
      }
    };
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      setState(() {
                        ...
                        print(nationality);
                        var resullt = nationality.compareTo("Indian");
                        if (resullt == 0) {
                          totakdisplayamount = int.parse(_adult.text) *
                                  widget.amountperadult +
                              int.parse(_child.text) * widget.amountperchild;
                          _amount.text = totakdisplayamount.toString();
                        } else {
                          totakdisplayamount = total * widget.foreigner;
                          _amount.text = totakdisplayamount.toString();
                        }
